...
\begin{itemize}
  \item We formulate trajectory-mined repair as nested execution-evidence orders plus terminal closure, prove finite monotone supervision, policy-event inclusion, certified non-regression, and minimum-breadth escalation, and provide executable audits of these properties.

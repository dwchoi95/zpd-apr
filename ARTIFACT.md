...
| `tab:breadth-audit` | purposive reporting audit and source coding recorded with the paper-facing bibliography checks; NR cells denote information absent from the cited report |
| `tab:mechanism-ladder` | `analysis/fse2027-stochastic-candidate-control.json`; `analysis/fse2027-breadth-controls.json`; `analysis/fse2027-answer9-control.json`; matched adjacent contrasts regenerated by `scripts/build_fse2027_result_bridge.py` |

...
| `tab:replication-ladder` | `analysis/fse2027-answer9-control.json`; `analysis/fse2027-scale-1.5b.json`; `analysis/fse2027-codeworkout-problem-holdout.json`; consolidated macros in `analysis/fse2027-result-bridge.json` |
